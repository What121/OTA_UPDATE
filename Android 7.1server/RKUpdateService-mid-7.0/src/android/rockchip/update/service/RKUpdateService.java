        ...
        for (VolumeInfo volume : volumes) {
            ...
            if(disk.isSd()){
                if(volume.fsType.equals("ntfs") || volume.fsType.equals("exfat")){
                    ...
                    Toast.makeText(mContext, mContext.getString(R.string.sd_head) + volume.fsType + mContext.getString(R.string.fat_warn), Toast.LENGTH_LONG).show();
                    continue ;
                }
            }else if(disk.isUsb()){
                if(volume.fsType.equals("ntfs") || volume.fsType.equals("exfat")){
                    Log.e(TAG, "usb fstype is " + volume.fsType);
                    Toast.makeText(mContext, mContext.getString(R.string.usb_head) + volume.fsType + mContext.getString(R.string.fat_warn), Toast.LENGTH_LONG).show();
                    continue ;
                }
            }
            if(flag == 0){
